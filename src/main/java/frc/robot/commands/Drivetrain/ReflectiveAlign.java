...
public class ReflectiveAlign extends CommandBase {
  ...
  private final PIDController yController = new PIDController(0.15, 0.0, 0.0);
  ...
  private final ProfiledPIDController omegaController =
      new ProfiledPIDController(
          Constants.Autonomous.DRIVE_CONTROLLER_ROTATION_KP, 0, 0, OMEGA_CONSTRAINTS);
  ...
  public void execute() {
    ...
    double omegaFeedback =
        omegaController.calculate(m_drivetrain.getPose().getRotation().getRadians());
