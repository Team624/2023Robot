...
public class FastSideIntake extends SequentialCommandGroup {
  /** Creates a new FastSideIntake. */
  ...
  public FastSideIntake(Arm arm, Telescope telescope, Wrist wrist) {
    ...
    this.m_Wrist = wrist;
    addCommands(new SideIntakeArmWrist(arm, wrist), new ParallelCommandGroup(new SetTelescope(telescope, 0.4)));
  }
}
